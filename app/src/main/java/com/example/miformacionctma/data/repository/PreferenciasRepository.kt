...
class PreferenciasRepository(
    ...
    private object PreferencesKeys {
        ...
        val TEXTO_BUSQUEDA = stringPreferencesKey("texto_busqueda")
    }

    val filtroCategoria: Flow<String> =
    ...
    val textoBusqueda: Flow<String> =
        context.dataStore.data
            .map { preferences ->
                preferences[PreferencesKeys.TEXTO_BUSQUEDA] ?: ""
            }
    ...
    suspend fun guardarTextoBusqueda(texto: String) {
        context.dataStore.edit { preferences ->
            preferences[PreferencesKeys.TEXTO_BUSQUEDA] = texto
        }
    }
}
